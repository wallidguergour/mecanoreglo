...
$address = "fredprecourt@gmail.com";
...
if(mail($address, $received_subject, $message, $header)) {
	...
	echo "<h2>Votre email a bien été envoyé.</h2>";
	echo "<p>Merci! <strong>$name</strong>, Qui sais, peut être que l'ont auras l'occasion de travailler enssemble!</p>";
